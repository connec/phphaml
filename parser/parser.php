...
abstract class Parser {
	 ...
	 */
	protected static $document_namespace;
	...
	public function __construct($source, $options = array()) {
		...
		if(!static::$document_namespace) {
			static::$document_namespace = str_replace(
			    array('\\parser\\', 'Parser'),
			    array('\\document\\', ''),
			    get_class($this)
		    );
	...
	protected function create_node($type) {
		...
		$class = static::$document_namespace . $type . 'Node';
	...
	public function parse() {
		...
		$document = static::$document_namespace . 'Document';
